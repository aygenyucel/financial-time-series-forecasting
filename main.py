...
def create_lagged_series(symbol, start_date, end_date, lags=5):
    ...
    plot_features = tslag[plot_cols][2904:]    
...
if __name__ == '__main__' :
    # Create a lagged series of the USD/TRY index: TRY=X; XU100.IS = BIST100; ^XU100;  (2021,6,23)
    snpret = create_lagged_series("TRY=X", datetime.datetime(2016,1,1), datetime.datetime.now(), lags=5)
    ...
    start_test = datetime.datetime(2020,6,23)
    ...
    print ("Hit Rates of USD/TRY:")
    models = [("LR", LR(max_iter=1000000, solver = 'sag', C= 1000000)), ("LDA", LDA(solver = 'lsqr')), ("QDA", QDA()), 
                        ("LSVC", LinearSVC(max_iter=1000000, C=10)),
                        ("DTC", DTC(random_state=20)),
                        #  ("KCM", KerasClassifier(build_fn=baseline_model,
